...
//";
        ...
        private string _filenameRelatorio = string.Empty;
        private string _titleRelatorio = string.Empty;
        private string _subtitleRelatorio = string.Empty;
        private string _footerRelatorio = string.Empty;

        public string FilenameRelatorio => _filenameRelatorio;
        public string TitleRelatorio => _titleRelatorio;
        public string SubtitleRelatorio => _subtitleRelatorio;
        public string FooterRelatorio => _footerRelatorio;
        ...
        public ArquivoRelatorioMultiDesenhos(string template)
        {
            ...
            _template = Path.Combine(DIRETORIO, template);

            string nomeRelatorio = Guid.NewGuid().ToString("N").Substring(0, 8);
            _filenameRelatorio =  Path.Combine(DIRETORIO, nomeRelatorio + ".xsr");
        }

        

        public void CriarTemplateRelatorio()
        {
            System.IO.File.WriteAllText(_template, CONTEUDO);

        }

        public void DeleteTemplate(string nomeArquivo)
        {
        ...
        private static void deleteArquivo(string nomeArquivo)
        {
        ...
        public void DeleteRelatorios()
        {
            List<string> arquivos = Directory.GetFiles(DIRETORIO, "*.xsr").ToList();
